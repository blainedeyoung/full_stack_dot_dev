...
urlpatterns = [
    ...
    path("course-update/<slug:course>/", views.CourseUpdateView.as_view(), name="course-update"),
    path("course-delete/<slug:course>/", views.CourseDeleteView.as_view(), name="course-delete"),
